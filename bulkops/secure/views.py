...
def signup():
    ...
    if form.validate_on_submit():
        ...
        i = len(s)
        # fallback mechanism, just in-case username checker breaks
...
# Atlassian Descriptor file
@bulk.route("/atlassian-connect.json", methods=["GET", "POST"])
def atlassian():
    page = (
        {
            "name": "BulkOps App",
            "description": "Bulk Operations App",
            "key": "com.elfapp.bulkops",
            "baseUrl": "https://stark-depths-73002.herokuapp.com",
            "links": {
                "self": "/atlassian-connect.json",
                "homepage": "/atlassian-connect.json"
            },
            "vendor": {
                "name": "Elf App",
                "url": "https://elfapp.website"
            },
            "authentication": {
                "type": "none"
            },
                ...
                "adminPages": [
                    {
                        "url": "/index",
                        "name": {
                            "value": "BulkOps Admin Page"
                        },
                        "key": "bulkopsapp-admin-panel"
                    }
                ],
                "configurePage": {
                    "url": "/settings",
                    "name": {
                        "value": "BulkOps App Configure Page"
                    },
                    "key": "bulkopsapp-config-page"
                },
                "webSections": [
                    {
                        "key": "bulkops-admin-section",
